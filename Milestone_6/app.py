...
# -------------------------------
# UNIVERSAL UI FIX (LIGHT + DARK SAFE)
# -------------------------------
st.markdown("""
<style>
...
price = st.sidebar.slider("Current Price", 50.0, 500.0, 100.0)
...
# OPTIONAL SMALL TEXT (DEMAND)
st.caption(f"Estimated Demand: {predicted_demand:.2f}")
