...
feature_order = joblib.load("features.pkl")  # This is a saved list of features (in training order)
...
# Demand Level Input (Optional: can also default or derive from demand logic)
...
input_df = input_df[feature_order]  # Ensure exact feature order as in training
